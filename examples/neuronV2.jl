...
brhopf = continuation(br, 1, (@lens _.c),
         setproperties(br.contparams, detectBifurcation = 2, dsmax = 0.01, maxSteps = 100, pMax = 1.1, pMin = -0.1,ds = -0.01);
...
br2 = BK.continuation(prob2, PALC(), setproperties(opts, pMax = 1.2); verbosity = 1, plot = true, bothside = false)
